...
--- Generates a table entry for a given file / line number in the call graph.
-- @param cg Call graph to use.
-- @param file File in that call graph, can be "symbol" which means that we do not know the file and
...
-- @param table_fn Function that takes an event and generates a table of entries like
--        hottest_lines_table or hottest_symbols_table.
